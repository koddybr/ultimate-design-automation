...
public class Investment {
    public static void main(String[] args) {
        ...
        await.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[text()='Inversiones']")));
        WebElement optionSupplyMenu = driver.findElement(By.xpath(".//*[text()='Inversiones']"));
        ...
        await.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[aria-label='Codigo']")));
        WebElement optionCode = driver.findElement(By.cssSelector("[aria-label='Codigo']"));
        optionCode.click();
        optionCode.sendKeys("123456");
        ...
        optionDescription.sendKeys("Madera terminada");
