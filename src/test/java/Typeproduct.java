...
public class Typeproduct {
    public static void main(String[] args) {
        ...
        await.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[text()='Tipo de Productos']")));
        WebElement optionSupplyMenu = driver.findElement(By.xpath(".//*[text()='Tipo de Productos']"));
        ...
        optionName.click();
        optionName.sendKeys("Producto primero");
        ...
        optionDescription.sendKeys("Tarea compleetada");
    }
}